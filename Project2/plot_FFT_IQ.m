...
N=length(z); freq=[0:1:N-1]*(fs)/N+Low_freq; plot(freq,z);
axis tight
...
title({title_of_plot,['Center frequency = ' num2str(f0) ' MHz'] },'FontSize', 14)

%Add vertical line
y1=get(gca,'ylim'); hold on; plot([f0 f0],y1,'r-','linewidth',2); hold off;
